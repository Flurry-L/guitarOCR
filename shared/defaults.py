...
MEASURE_ADAPTER = Path("weights/glm_ocr_measure_sequence_v2_lora")
INFO_ADAPTER = Path("weights/glm_ocr_document_info_v2_lora")
LAYOUT_MODEL = Path("weights/pp_doclayout_v3_score_sparse")
